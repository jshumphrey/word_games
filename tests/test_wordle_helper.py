...
class TestWord(unittest.TestCase):
    ...
    def test_init(self):
        ...
        test_word_1 = wordle.WordleWord("slate")
        ...
        test_word_2 = wordle.WordleWord("teeth")
    ...
    def test_calculate_guess_results_normal(self):
        ...
        test_word_1 = wordle.WordleWord("slate")
        self.assertEqual(test_word_1.calculate_guess_results(wordle.WordleWord("ratio")), "byybb")
        self.assertEqual(test_word_1.calculate_guess_results(wordle.WordleWord("slide")), "ggbbg")
        self.assertEqual(test_word_1.calculate_guess_results(wordle.WordleWord("slate")), "ggggg")

    def test_calculate_guess_results_dupes(self):
        """Test that Word.calculate_guess_results correctly calculates Wordle guess results
        when the input word or guessed words do have duplicate letters."""
        test_word_1 = wordle.WordleWord("teeth")
        self.assertEqual(test_word_1.calculate_guess_results(wordle.WordleWord("table")), "gbbby")
        self.assertEqual(test_word_1.calculate_guess_results(wordle.WordleWord("genie")), "bgbby")
        self.assertEqual(test_word_1.calculate_guess_results(wordle.WordleWord("teens")), "gggbb")
        self.assertEqual(test_word_1.calculate_guess_results(wordle.WordleWord("epees")), "ybgbb")
